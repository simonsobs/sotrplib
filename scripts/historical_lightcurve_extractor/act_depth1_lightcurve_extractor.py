...
from sotrplib.utils.utils import radec_to_str_name, fit_poss
from sotrplib.maps.maps import get_time_safe, get_submap
import os
...
poss = np.array([[d*pixell_utils.degree for d in args.dec],[r*pixell_utils.degree for r in args.ra]])

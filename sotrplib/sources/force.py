...
class Lmfit2DGaussianFitter(ForcedPhotometryProvider):
    ...
    def force(
        ...
        fit_sources = lmfit_2d_gaussian_fit(
            input_map,
            source_list=source_list,
            flux_lim_fit_centroid=self.flux_limit_centroid,
            thumbnail_half_width=self.thumbnail_half_width,
...
class Lmfit2DGaussianPointingFitter(ForcedPhotometryProvider):
    min_flux: u.Quantity
    reproject_thumbnails: bool
    thumbnail_half_width: u.Quantity
    allowable_center_offset: u.Quantity
    ...
    def force(
        ...
        self.log.info(
            "Lmfit2DGaussianPointingFitter.force",
            n_sources=len(pointing_source_list),
            min_flux=self.min_flux,
            thumbnail_half_width=self.thumbnail_half_width,
            fwhm=fwhm,
